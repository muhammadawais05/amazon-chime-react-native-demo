...
RCT_EXPORT_METHOD(startMeeting:(NSDictionary *)meetingInfoDict attendeeInfo:(NSDictionary *)attendeeInfoDict)
{
  ...
  NSString *message2 = @"outside start";

    NSLog( @"Here is a test message: '%@'", message2 );
...
-(void)startAudioClient
{
  ...
  NSString *message1 = @"After nil";

    NSLog( @"Here is a test message: '%@'", message1 );
